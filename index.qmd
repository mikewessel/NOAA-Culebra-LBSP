...
There are 13 sites in the Nearshore sampling components that are to be sampled monthly so print 13 datasheets using the following link [Watershed Datasheets](https://docs.google.com/document/d/1blpa4Iob9zMFprBdBVjw-C5EYTtMRYO7/edit)
