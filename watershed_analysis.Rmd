...
# read in googlesheet
W_Lab<-data.frame(read_sheet("https://docs.google.com/spreadsheets/d/1qWWiaY-w2_Z-NJINq-mnOCpXk_fTmuQxA0sgXArYbgg/edit?usp=sharing"))
...
labelit<-paste(max(L3$Year),"-",max(L3$Month))
```
...
df2 <- as.data.frame(lapply(L3, unlist))
df3<-df2%>%
